...
export const RECEIVE_DURATION = COVER_HOLD + 396;
...
const Hook: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", padding: 100 }}>
      ...
      >
        Tu penses avoir jusqu&apos;en{" "}
        <span style={{ color: COLORS.gold }}>2027</span>…
      </div>
      <Caption opacity={fadeScene(frame, durationInFrames)}>Sauf pour la réception.</Caption>
    </AbsoluteFill>
  );
};
...
export const ReceiveReel: React.FC<{ withBgm?: boolean }> = ({ withBgm = true }) => (
  <AbsoluteFill>
    <AudioBed withBgm={withBgm} voFile="campaign/audio/j12-vo.mp3" />
    <ReelShell cover={{ kicker: "Réception 2026", title: "Recevoir, dès septembre 2026." }}>
      <Sequence durationInFrames={90}>
        <Hook />
      </Sequence>
      <Sequence from={90} durationInFrames={108}>
        <Beat
          kicker="1er septembre 2026"
          title="Obligatoire pour tous"
          body="Toutes les entreprises doivent pouvoir recevoir une facture électronique."
          caption="Micro, auto-entrepreneur, sans TVA : inclus."
        />
      </Sequence>
      <Sequence from={198} durationInFrames={108}>
        <Beat
          kicker="Pourquoi si tôt ?"
          title="Un seul fournisseur suffit"
          body="Dès qu'un de tes fournisseurs bascule, tu dois pouvoir recevoir sa facture."
          caption="Attendre 2027, c'est trop tard pour recevoir."
        />
      </Sequence>
